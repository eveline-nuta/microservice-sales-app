...
import com.inventory.app.web.rest.errors.BadRequestAlertException;
import com.inventory.app.web.rest.util.HeaderUtil;
...
public class StockItemResource {
    ...
    private static final String ENTITY_NAME = "inventoryStockItem";
